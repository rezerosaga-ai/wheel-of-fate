CREATE TABLE IF NOT EXISTS "wof_rooms" (
...
CREATE TABLE IF NOT EXISTS "wof_game_state" (
	"id" serial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "wof_chat_messages" (
	"id" serial PRIMARY KEY NOT NULL,
	"room_code" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "wof_reflections" (
	"id" serial PRIMARY KEY NOT NULL,
	"room_code" text NOT NULL,
	"player_id" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "wof_topics" (
	"id" serial PRIMARY KEY NOT NULL,
	"room_code" text NOT NULL,
	"topic" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "wof_questions" (
	"id" serial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "wof_conflict_sessions" (
	"id" serial PRIMARY KEY NOT NULL,
	"room_code" text NOT NULL,
	"topic" text NOT NULL,
